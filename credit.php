    ...
    <main class="table" id="subsidy_table">
        ...
        <section class="table_body">
            <table>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM subsidy WHERE outstanding > 0";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "</td>";
                            echo '<td>';
                            echo '<i class="fa-regular fa-pen-to-square" style="color: green; margin-left: 20px; cursor: pointer;" data-id="' . $row['sno'] . '" onclick="editRecord(' . $row['sno'] . ')"></i>';
